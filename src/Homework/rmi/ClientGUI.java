...
public class ClientGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Number of ants outside the colony");

        jLabel2.setText("Number of worker ants inside the colony");

        jLabel3.setText("Number of soldier ants doing instruction");

        jLabel4.setText("Number of sildier ants fighting an invasion");

        jLabel5.setText("Number of baby ants in the eating area");

        jLabel6.setText("Number of baby ants in the shelter");

        jButton1.setText("Generate insect invasion");
    ...
    public void updateFields() {
        this.updateJTextField1();
        this.updateJTextField2();
        this.updateJTextField3();
        this.updateJTextField4();
        this.updateJTextField5();
        this.updateJTextField6();
